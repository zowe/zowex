...
JNIEXPORT jint JNICALL Java_org_zowe_zowex_zos_security_jni_Secur_createSecurityEnvironmentByDaemon(JNIEnv *env, jobject obj, jstring user, jstring applId)
{
    int rc = EINVAL;
...
JNIEXPORT jint JNICALL Java_org_zowe_zowex_zos_security_jni_Secur_createSecurityEnvironment(JNIEnv *env, jobject obj, jstring user, jstring password, jstring applId)
{
    int rc = EINVAL;
    char *platformUser = jstring_to_ebcdic(env, user);
...
JNIEXPORT jint JNICALL Java_org_zowe_zowex_zos_security_jni_Secur_removeSecurityEnvironment(JNIEnv *env, jobject obj)
{
    return pthread_security_applid_np(__DELETE_SECURITY_ENV, __USERID_IDENTITY, 0, NULL, NULL, 0, NULL);
}

JNIEXPORT jint JNICALL Java_org_zowe_zowex_zos_security_jni_Secur_getLastErrno2(JNIEnv *env, jobject obj)
{
    return lastErrno2;
}

JNIEXPORT jint JNICALL Java_org_zowe_zowex_zos_security_jni_Secur_setApplid(JNIEnv *env, jobject obj, jstring jApplid)
{
    void *__ptr32 psa = 0;
