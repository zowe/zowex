...
- **Breaking:** `c`: Changed the default behavior of data set reads to not return the e-tag unless explicitly requested. The `etag` field in the `ReadDatasetResponse` JSON-RPC schema is now optional.
